function fcnSingleSwimmerPlot(T)
% Create swimmer plots for the epilepsy simulation data with properly displayed
% treatment status, death, and censoring - FULL WIDTH VERSION
%
% T: Table with columns sid, t, Rx, harmE, harmA, b0, L, A, V, Y
%
% Creates 3 subplots in a single column taking full figure width
...
bottom_margin = 0.10;    % Bottom margin (larger to accommodate xlabel)

% Calculate width using full figure width
width = 1 - left_margin - right_margin;

% Calculate heights for 3 plots plus space for 4th
