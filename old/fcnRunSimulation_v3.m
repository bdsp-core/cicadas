function [t, z, t1, t2, p, L, A, V, Y, switchTime, hY, SY, hA, SA, hV, SV] = fcnRunSimulation_v3(Rx, harmE, harmA, C, g, th, kp, ki, Amax, b0, pulseAmp, pulseMu, pulseWidth, pulseC, sim_mode)
